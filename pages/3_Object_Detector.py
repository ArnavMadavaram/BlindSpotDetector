...
st.set_page_config(page_title="Object Detector", layout="centered", page_icon="🔍")
st.markdown("<h1 style='text-align: center; color: #00ffcc;'>🔍 Object Detector</h1>", unsafe_allow_html=True)
